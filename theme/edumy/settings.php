...
if ($ADMIN->fulltree) {
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/blogstyle',
    get_string('blogstyle', 'theme_edumy'),
    get_string('blogstyle_desc', 'theme_edumy'),
    null,
    array(
      '1' => 'Blog style 1',
      '2' => 'Blog style 2',
  ...
  // Back to Top
  $setting = new admin_setting_configselect(
    'theme_edumy/back_to_top',
    get_string('back_to_top', 'theme_edumy'),
    get_string('back_to_top_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Back to Top
  $setting = new admin_setting_configselect(
    'theme_edumy/language_menu',
    get_string('language_menu', 'theme_edumy'),
    get_string('language_menu_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Display as flags',
      '1' => 'Display as text'
  ...
  // Logotype
  $setting = new admin_setting_configselect(
    'theme_edumy/logotype',
    get_string('logotype', 'theme_edumy'),
    get_string('logotype_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Logo image
  $setting = new admin_setting_configselect(
    'theme_edumy/logo_image',
    get_string('logo_image', 'theme_edumy'),
    get_string('logo_image_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Logotype Footer
  $setting = new admin_setting_configselect(
    'theme_edumy/logotype_footer',
    get_string('logotype_footer', 'theme_edumy'),
    get_string('logotype_footer_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Logo image Footer
  $setting = new admin_setting_configselect(
    'theme_edumy/logo_image_footer',
    get_string('logo_image_footer', 'theme_edumy'),
    get_string('logo_image_footer_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Library list
  $setting = new admin_setting_configselect(
    'theme_edumy/library_list',
    get_string('library_list', 'theme_edumy'),
    get_string('library_list_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Hidden',
      '1' => 'Visible'
  ...
  // Search
  $setting = new admin_setting_configselect(
    'theme_edumy/header_search',
    get_string('header_search', 'theme_edumy'),
    get_string('header_search_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Show icon',
      '1' => 'Show searchbar',
  ...
  // Login
  $setting = new admin_setting_configselect(
    'theme_edumy/header_login',
    get_string('header_login', 'theme_edumy'),
    get_string('header_login_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Login popup',
      '1' => 'Login link',
  ...
  // Menu
  $setting = new admin_setting_configselect(
    'theme_edumy/header_main_menu',
    get_string('header_main_menu', 'theme_edumy'),
    get_string('header_main_menu_desc', 'theme_edumy'),
    '0',
    array(
  ...
  // Header type
  $setting = new admin_setting_configselect(
    'theme_edumy/headertype',
    get_string('headertype', 'theme_edumy'),
    get_string('headertype_desc', 'theme_edumy'),
    null,
    array(
      '1' => 'Header 1',
      '2' => 'Header 2',
  ...
  // Call to Action icon
  $setting = new admin_setting_configselect(
    'theme_edumy/cta_icon_ccn_icon_class',
    get_string('cta_icon', 'theme_edumy'),
    get_string('cta_icon_desc', 'theme_edumy'),
    'flaticon-megaphone',
    $ccnFontList
  );
  $page->add($setting);
  ...
  // Breadcrumb style
  $setting = new admin_setting_configselect(
    'theme_edumy/breadcrumb_style',
    get_string('breadcrumb_style', 'theme_edumy'),
    get_string('breadcrumb_style_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Default (large)',
      '1' => 'Medium',
  ...
  // Breadcrumb title
  $setting = new admin_setting_configselect(
    'theme_edumy/breadcrumb_title',
    get_string('breadcrumb_title', 'theme_edumy'),
    get_string('breadcrumb_title_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden',
  ...
  // Breadcrumb trail
  $setting = new admin_setting_configselect(
    'theme_edumy/breadcrumb_trail',
    get_string('breadcrumb_trail', 'theme_edumy'),
    get_string('breadcrumb_trail_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/breadcrumb_clip',
    get_string('breadcrumb_clip', 'theme_edumy'),
    get_string('breadcrumb_clip_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Clip long text',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/breadcrumb_caps',
    get_string('breadcrumb_caps', 'theme_edumy'),
    get_string('breadcrumb_caps_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Capitalized',
      '1' => 'Lowercase',
  ...
  // Preloader duration
  $setting = new admin_setting_configselect(
    'theme_edumy/preloader_duration',
    get_string('preloader_duration', 'theme_edumy'),
    get_string('preloader_duration_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Wait for page to fully load (highly recommended)',
  ...
  // Footer copyright
  $setting = new admin_setting_configtext('theme_edumy/cocoon_copyright', get_string('cocoon_copyright', 'theme_edumy'), get_string('cocoon_copyright_desc', 'theme_edumy'), '© Copyright 2023 STECHOQ', PARAM_NOTAGS, 50);
  $setting->set_updatedcallback('theme_reset_all_caches');
  $page->add($setting);
  // Footer style
  $setting = new admin_setting_configselect(
    'theme_edumy/footertype',
    get_string('footertype', 'theme_edumy'),
    get_string('footertype_desc', 'theme_edumy'),
    null,
    array(
      '1' => 'Footer 1',
      '2' => 'Footer 2',
  ...
  if (class_exists('NumberFormatter')) {
    // Course price format
    $setting = new admin_setting_configselect(
      'theme_edumy/course_price_format',
      get_string('course_price_format', 'theme_edumy'),
      get_string('course_price_format_desc', 'theme_edumy'),
      '6',
      array(
        // '0' => 'US$49',
        // '1' => 'US$ 49',
  ...
  // Course ratings
  $setting = new admin_setting_configselect(
    'theme_edumy/course_ratings',
    get_string('course_ratings', 'theme_edumy'),
    get_string('course_ratings_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Hide all ratings',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/coursecat_modified',
    get_string('coursecat_modified', 'theme_edumy'),
    get_string('coursecat_modified_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/coursecat_enrolments',
    get_string('coursecat_enrolments', 'theme_edumy'),
    get_string('coursecat_enrolments_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/coursecat_announcements',
    get_string('coursecat_announcements', 'theme_edumy'),
    get_string('coursecat_announcements_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/coursecat_prices',
    get_string('coursecat_prices', 'theme_edumy'),
    get_string('coursecat_prices_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden',
  ...
  // Course list style
  $setting = new admin_setting_configselect(
    'theme_edumy/courseliststyle',
    get_string('courseliststyle', 'theme_edumy'),
    get_string('courseliststyle_desc', 'theme_edumy'),
    null,
    array(
      '1' => 'Grid',
      '2' => 'List'
  ...
  // Single Course Style
  $setting = new admin_setting_configselect(
    'theme_edumy/course_single_style',
    get_string('course_single_style', 'theme_edumy'),
    get_string('course_single_style_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Course v1',
      '1' => 'Course v2',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/course_enrolment_payment',
    get_string('course_enrolment_payment', 'theme_edumy'),
    get_string('course_enrolment_payment_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'All courses require payment',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/singlecourse_blocks',
    get_string('singlecourse_blocks', 'theme_edumy'),
    get_string('singlecourse_blocks_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Show on all pages of the course (Moodle default)',
  ...
  // Course Start Date
  $setting = new admin_setting_configselect(
    'theme_edumy/course_start_date',
    get_string('course_start_date', 'theme_edumy'),
    get_string('course_start_date_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Course Category
  $setting = new admin_setting_configselect(
    'theme_edumy/course_category',
    get_string('course_category', 'theme_edumy'),
    get_string('course_category_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/course_content_enroled_only',
    get_string('course_content_enroled_only', 'theme_edumy'),
    get_string('course_content_enroled_only_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Display course content to anyone with viewing access to the course',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/topics_format_collapsible',
    get_string('topics_format_collapsible', 'theme_edumy'),
    get_string('topics_format_collapsible_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'All collapsed by default',
  ...
  // Quiz layout
  $setting = new admin_setting_configselect(
    'theme_edumy/quiz_layout',
    get_string('quiz_layout', 'theme_edumy'),
    get_string('quiz_layout_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Quiz navigation: Top',
  ...
  // New Window
  $setting = new admin_setting_configselect(
    'theme_edumy/social_target',
    get_string('social_target', 'theme_edumy'),
    get_string('social_target_desc', 'theme_edumy'),
    null,
    array(
  ...
  // Dashboard header
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_header',
    get_string('dashboard_header', 'theme_edumy'),
    get_string('dashboard_header_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Gradient',
      '1' => 'White'
  ...
  // Sticky header
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_sticky_header',
    get_string('dashboard_sticky_header', 'theme_edumy'),
    get_string('dashboard_sticky_header_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Stick to top',
      '1' => 'Scroll with page'
  ...
  // Sticky left drawer
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_sticky_drawer',
    get_string('dashboard_sticky_drawer', 'theme_edumy'),
    get_string('dashboard_sticky_drawer_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Stick to side',
      '1' => 'Scroll with page'
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_left_drawer',
    get_string('dashboard_left_drawer', 'theme_edumy'),
    get_string('dashboard_left_drawer_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'User menu (default)',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/breadcrumb_clip_dash',
    get_string('breadcrumb_clip', 'theme_edumy'),
    get_string('breadcrumb_clip_desc', 'theme_edumy'),
    0,
    array(
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_1_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Show tablet',
      '1' => 'Hide tablet'
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_1_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
  ...
  // Dashboard tablet visibility
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_2_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  // Dashboard tablet icon
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_2_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'flaticon-cap',
    $ccnFontList
  ...
  // Dashboard tablet visibility
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_3_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  // Dashboard tablet icon
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_3_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'flaticon-settings',
    $ccnFontList
  ...
  // Dashboard tablet visibility
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_4_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  // Dashboard tablet icon
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_tablet_4_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'flaticon-rating',
    $ccnFontList
  ...
  // Login Layout
  $setting = new admin_setting_configselect(
    'theme_edumy/login_layout',
    get_string('login_layout', 'theme_edumy'),
    get_string('login_layout_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Style 1 (default)',
      '1' => 'Style 2',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/navigation_icon_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/navigation_icon_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'flaticon-settings',
    $ccnFontList
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/notification_icon_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/notification_icon_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'flaticon-alarm',
    $ccnFontList
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/messages_icon_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/messages_icon_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'flaticon-speech-bubble',
    $ccnFontList
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/dark_mode_icon_visibility',
    get_string('config_visibility', 'theme_edumy'),
    get_string('config_visibility_desc', 'theme_edumy'),
    0,
    array(
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/dark_mode_icon_ccn_icon_class',
    get_string('config_icon_class', 'theme_edumy'),
    get_string('config_icon_class_desc', 'theme_edumy'),
    'ccn-flaticon-hide',
    $ccnFontList
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/profile_icon_username',
    get_string('profile_icon_username', 'theme_edumy'),
    get_string('profile_icon_username_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Username',
      '1' => 'Full name'
  ...
  // Primary Font
  $setting = new admin_setting_configselect(
    'theme_edumy/primary_font',
    get_string('primary_font', 'theme_edumy'),
    get_string('primary_font_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Nunito',
      '1' => 'Dosis',
  ...
  // Secondary Font
  $setting = new admin_setting_configselect(
    'theme_edumy/secondary_font',
    get_string('secondary_font', 'theme_edumy'),
    get_string('secondary_font_desc', 'theme_edumy'),
    5,
    array(
      '0' => 'Nunito',
      '1' => 'Dosis',
  ...
  // Dashboard Layout
  $setting = new admin_setting_configselect(
    'theme_edumy/dashboard_layout',
    get_string('dashboard_layout', 'theme_edumy'),
    get_string('dashboard_layout_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Edumy Dashboard (default)',
      '1' => 'Edumy',
    )
  );
  $setting->set_updatedcallback('theme_reset_all_caches');
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/coursemainpage_layout',
    get_string('coursemainpage_layout', 'theme_edumy'),
    get_string('coursemainpage_layout_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Edumy (default) - recommended',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/incourse_layout',
    get_string('incourse_layout', 'theme_edumy'),
    get_string('incourse_layout_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Edumy (default)',
      '1' => 'Edumy Dashboard',
  ...
  // Profile Page Layout
  $setting = new admin_setting_configselect(
    'theme_edumy/user_profile_layout',
    get_string('user_profile_layout', 'theme_edumy'),
    get_string('user_profile_layout_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Edumy (default)',
      '1' => 'Edumy Dashboard'
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/edumy_focus_sidebar',
    get_string('edumy_focus_sidebar', 'theme_edumy'),
    get_string('edumy_focus_sidebar_desc', 'theme_edumy'),
    '0',
    array(
      '0' => 'Display sidebar',
      '1' => 'Hide sidebar'
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/edumy_homepage_core',
    get_string('edumy_homepage_core', 'theme_edumy'),
    get_string('edumy_homepage_core_desc', 'theme_edumy'),
    '0',
    array(
  ...
  // Lazy Loading
  $setting = new admin_setting_configselect(
    'theme_edumy/lazy_loading',
    get_string('lazy_loading', 'theme_edumy'),
    get_string('lazy_loading_desc', 'theme_edumy'),
    0,
    array(
      '0' => 'Yes (default)',
      '1' => 'No',
  ...
  // Blog Post Author
  $setting = new admin_setting_configselect(
    'theme_edumy/blog_post_author',
    get_string('blog_post_author', 'theme_edumy'),
    get_string('blog_post_author_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  // Blog Post Date
  $setting = new admin_setting_configselect(
    'theme_edumy/blog_post_date',
    get_string('blog_post_date', 'theme_edumy'),
    get_string('blog_post_date_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Visible',
      '1' => 'Hidden'
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/page_settings_controls',
    get_string('page_settings_controls', 'theme_edumy'),
    get_string('page_settings_controls_desc', 'theme_edumy'),
    null,
    array(
      '0' => 'Moodle default (visible based on permissions)',
  ...
  $setting = new admin_setting_configcheckbox(
    'theme_edumy/iconset_fontawesome',
  ...
  $setting = new admin_setting_configcheckbox(
    'theme_edumy/iconset_lineawesome',
  ...
  $setting = new admin_setting_configselect(
    'theme_edumy/dev_expose_blocks',
    get_string('dev_expose_blocks', 'theme_edumy'),
    get_string('dev_expose_blocks_desc', 'theme_edumy'),
    '0',
    array(
      '0' => 'No (default & highly recommended)',
