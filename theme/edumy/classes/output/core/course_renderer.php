...
class course_renderer extends \core_course_renderer
{
  ...
  protected function coursecat_coursebox_content(coursecat_helper $chelper, $course)
  {
    ...
    $contenttext = '';
    if ((isset($PAGE->theme->settings->coursecat_enrolments)
  ...
  protected function frontpage_part($skipdivid, $contentsdivid, $header, $contents)
  {
    ...
    $output .= '<div class="row">
                  <div class="col-lg-6 offset-lg-3">
                    <div class="main-title text-center">
                      ...
                      <p>Take our course and reach your career goals <br>
    ...
    $output .= '<div class="row">
                  <div class="col-lg-6 offset-lg-3">
                    <div class="main-title text-center">
                    <div class="btn btn-danger" style="background-color: transparent; color: #003666; border: 1px solid #003666; padding: 10px 20px; cursor: pointer;">See More</div>
                    </div>
                  </div>
                </div>';
