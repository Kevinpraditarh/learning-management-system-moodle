...
$string['modulename'] = 'Stechoq Content Pages';
$string['modulenameplural'] = 'Stechoq Content Pages';
$string['modulename_help'] = 'Stechoq Content Pages';
...
$string['pluginname'] = 'Stechoq Content Pages';
