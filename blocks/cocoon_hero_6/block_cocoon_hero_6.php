...
class block_cocoon_hero_6 extends block_base
{
  ...
  public function get_content()
  {
    ...
    if (!empty($this->config->button_link_2)) {
      $this->content->button_link_2 = $this->config->button_link_2;
    } else {
      $this->content->button_link_2 = '';
    }
    if (!empty($this->config->button_text_2)) {
      $this->content->button_text_2 = $this->config->button_text_2;
    } else {
      $this->content->button_text_2 = '';
    }
    if (!empty($this->config->color_title)) {
      $this->content->color_title = $this->config->color_title;
    } else {
      $this->content->color_title = '#221538';
    }
    ...
    if (!empty($this->config->color_btn_1)) {
      $this->content->color_btn_1 = $this->config->color_btn_1;
    } else {
      $this->content->color_btn_1 = '#ff1053';
    }
    if (!empty($this->config->color_btn_2)) {
      $this->content->color_btn_2 = $this->config->color_btn_2;
    } else {
      $this->content->color_btn_2 = '#051925';
    }
    if (!empty($this->config->color_btn_1_hover)) {
      $this->content->color_btn_1_hover = $this->config->color_btn_1_hover;
    } else {
      $this->content->color_btn_1_hover = '#ff1053';
    }
    if (!empty($this->config->color_btn_2_hover)) {
      $this->content->color_btn_2_hover = $this->config->color_btn_2_hover;
    } else {
      $this->content->color_btn_2_hover = '#051925';
    }
    ...
    $this->content->text = '
        <div class="bg-img9" data-ccn="image" data-ccn-img="bg-img-url" style="background-size:cover;">
        <div class= "container">
            <div class="row">
              <div class="col-lg-6 ">
              <img src="' . $ccnImages_teacher . '">
              </div>
              <div class="col-lg-6 text-left d-flex align-items-left justify-content-center flex-column">
                  <h2
                    class="title"
                    data-ccn="title"
